        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion text-red" id="accordionSidebar" style="background: green">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon">
                    ...
                    <img src={{asset('assets/img/krb.jpg')}} height="60px" />
                    
                </div>
                
                <div class="sidebar-brand-text mx-3"> KRB</div>
            </a>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">User</span>
                                    ...
                                    <img src={{asset('assets/img/krb.jpg')}} height="60px" class="img-profile rounded-circle" />
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; KRB @php echo Date('Y') @endphp</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
